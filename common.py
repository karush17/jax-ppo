...
class MLP(nn.Module):
    """Implements a stadard NN architecture.
    
    Attributes:
        hidden_dims: number of hidden units.
        activations: activation function.
        activate_final: whether to use activation after output.
...
class Model:
    """Implements the training state of the model.
    
    Attributes:
        step: training step.
        apply_fn: function for updating parameters.
        params: trainable parameters of the agent.
    ...
    def create(cls,
        ...
        """Creates the model class object."""
